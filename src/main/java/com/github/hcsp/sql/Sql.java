...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        try (PreparedStatement statement = databaseConnection.prepareStatement("select \"ORDER\".GOODS_ID, GOODS.NAME, sum(\"ORDER\".GOODS_NUM * \"ORDER\".GOODS_PRICE) as GMV from \"ORDER\"\n" +
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        return executeOrdersQuerySQL(databaseConnection, "select \"ORDER\".ID, USER.NAME, GOODS.NAME, \"ORDER\".GOODS_NUM * \"ORDER\".GOODS_PRICE as TOTAL_PRICE\n" +
                "from \"ORDER\"\n" +
                "    join GOODS on GOODS.ID = \"ORDER\".GOODS_ID\n" +
...
// +----------+-----------+------------+-------------+
     ...
     * @throws SQLException
     */
    private static List<Order> executeOrdersQuerySQL(Connection databaseConnection, String sql) throws SQLException {
