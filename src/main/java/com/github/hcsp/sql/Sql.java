...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        ...
        try (PreparedStatement statement = databaseConnection.prepareStatement(
                "select \"GOODS\".id,GOODS.name, sum(\"ORDER\".GOODS_NUM*\"ORDER\".GOODS_PRICE) as gmv from \"ORDER\" "
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        ...
        try (PreparedStatement statement = databaseConnection.prepareStatement(
                "select \"ORDER\".id, USER.NAME, GOODS.NAME,\"ORDER\".GOODS_NUM*\"ORDER\".GOODS_PRICE as TOTAL_PRICE " +
                "from \"ORDER\" " +
                "join GOODS on \"ORDER\".GOODS_ID = GOODS.ID " +
                "join USER on \"ORDER\".USER_ID = USER.ID")) {
            getJoinOrders((List<Order>) orderList, statement);
        }
        return orderList;
    }

    private static void getJoinOrders(List<Order> orderList, PreparedStatement statement) throws SQLException {
        ResultSet resultSet = statement.executeQuery();
        while (resultSet.next()) {
