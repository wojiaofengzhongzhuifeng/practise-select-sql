...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        try (PreparedStatement statement = databaseConnection.prepareStatement("SELECT GOODS.ID  ,GOODS.NAME,SUM(\"ORDER\".GOODS_NUM * \"ORDER\".GOODS_PRICE) AS total FROM GOODS \n" +
                "JOIN \"ORDER\"\n" +
            ...
            while (resultSet.next()) {
                GoodsAndGmv list = new GoodsAndGmv();
                list.goodsId = resultSet.getInt(1);
                list.goodsName = resultSet.getString(2);
                list.gmv = resultSet.getString(3);
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        try(PreparedStatement statement = databaseConnection.prepareStatement("SELECT \"ORDER\".ID , USER.NAME, GOODS.name, (\"ORDER\".GOODS_PRICE*\"ORDER\".GOODS_NUM)FROM \"ORDER\" \n" +
                "JOIN \"USER\" \n" +
