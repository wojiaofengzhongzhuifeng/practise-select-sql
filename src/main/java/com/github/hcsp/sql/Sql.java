...
// +-----+
    public static int countUsersWhoHaveBoughtGoods(Connection databaseConnection, Integer goodsId) throws SQLException {
        try (PreparedStatement statement = databaseConnection.prepareStatement("select count(distinct `ORDER`.USER_ID) from `ORDER` where GOODS_ID = ?")) {
...
// +----+----------+------+----------+
    ...
    public static class GoodsAndGmv {
        ...
        public GoodsAndGmv(int id, String name, BigDecimal gmv) {
            this.goodsId = id;
            this.goodsName = name;
            this.gmv = gmv;
        }
...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = databaseConnection.prepareStatement("select g.id,g.name,tmp.GMV from (\n" +
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        try (PreparedStatement statement = databaseConnection.prepareStatement("select \"ORDER\".id,\"USER\".NAME as user_name,\"GOODS\".NAME as goods_name, \"ORDER\".GOODS_NUM*\"ORDER\".GOODS_PRICE as TOTAL_PRICE\n" +
                "from \"ORDER\"\n" +
                "\n" +
                "         join GOODS\n" +
