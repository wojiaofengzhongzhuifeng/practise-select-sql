...
// +------------+-----------------+------------------+---------------------+-------------------------------+
     ...
     * @param databaseConnection 数据库连接实例
     * @return 有多少用户买过这个商品
     */
...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = databaseConnection.prepareStatement(
                "select GOODS.ID, GOODS.NAME, SUM(\"ORDER\".GOODS_PRICE * \"ORDER\".GOODS_NUM) as GMV " +
                        "from GOODS " +
                        "         join \"ORDER\" " +
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        return getDifferentJoinTypeOrders(databaseConnection, INNER_JOIN);
...
// +----------+-----------+------------+-------------+
    public static List<Order> getLeftJoinOrders(Connection databaseConnection) throws SQLException {
        return getDifferentJoinTypeOrders(databaseConnection, LEFT_JOIN);
    }

    public static List<Order> getDifferentJoinTypeOrders(Connection databaseConnection, String joinType) throws SQLException {
        String sqlQuery = "";
        switch (joinType) {
            case LEFT_JOIN:
                sqlQuery = "select \"ORDER\".ID as ORDER_ID,USER.NAME as " +
                        "USER_name,GOODS.NAME as GOODS_NAME,\"ORDER\".GOODS_NUM * \"ORDER\".GOODS_PRICE as TOTAL_PRICE " +
                        "from \"ORDER\" " +
                        "         left join USER " +
