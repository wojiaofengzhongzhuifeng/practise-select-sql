...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        try (PreparedStatement statement = databaseConnection.prepareStatement("select GOODS.ID,GOODS.NAME,SUM(GOODS_NUM*GOODS_PRICE) as GMY from `ORDER` " +
                "join GOODS on `ORDER`.GOODS_ID = GOODS.ID group by GOODS_ID order by GMY desc")) {
            ResultSet resultSet = statement.executeQuery();
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        ...
        publicMethed(databaseConnection, sql, orderList);
        return orderList;
    }
...
// +----------+-----------+------------+-------------+
    ...
    private static void publicMethed(Connection databaseConnection, String sql, List<Order> orderList) throws SQLException {
        try (PreparedStatement st = databaseConnection.prepareStatement(sql)) {
