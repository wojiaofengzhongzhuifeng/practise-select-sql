...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        try (PreparedStatement preparedStatement = databaseConnection.prepareStatement("select `order`.goods_id, goods.name, sum(`order`.goods_num * `order`.goods_price) as total from `order`\n" +
                "join goods\n" +
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        try (PreparedStatement preparedStatement = databaseConnection.prepareStatement("select `order`.id, user.name, goods.name, `order`.goods_num * `order`.goods_price from `order`\n" +
                "join user\n" +
