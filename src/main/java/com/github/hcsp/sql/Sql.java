...
//  +----+--------+------+
    public static List<GoodsAndGmv> getGoodsAndGmv(Connection databaseConnection) throws SQLException {
        String sql = "SELECT B.ID,B.NAME,SUM(GOODS_NUM * GOODS_PRICE) AS GMV FROM `ORDER` AS A" +
                " JOIN GOODS B ON A.GOODS_ID = B.ID" +
                " GROUP BY B.ID ORDER BY GMV DESC";
...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        String sql = "SELECT A.ID AS ORDER_ID, B.NAME AS USER_NAME, C.NAME AS GOODS_NAME, GOODS_NUM*GOODS_PRICE AS TOTAL_PRICE FROM `ORDER` AS A" +
                " INNER JOIN USER AS B ON A.USER_ID = B.ID" +
                " INNER JOIN GOODS AS C ON A.GOODS_ID = C.ID";
